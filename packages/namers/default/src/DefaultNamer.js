...
export default new Namer({
  name(bundle: Bundle, bundleGraph: BundleGraph, opts: NamerOptions): FilePath {
    ...
    let bundleGroupBundles = bundleGraph.getBundles(
      bundleGraph.getBundleGroups(bundle)[0]
    );
